...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 30, 2022 at 10:28 AM
...
('d91749d5-842c-11ed-bfb0-b0227a7395f6', 1, '2022-12-25 09:18:36', NULL, NULL, NULL, 'banner-4.jpg', 'Big Sale, All new fashion brands items up to 70% off', 'Online Purchases Only', 'View Sale', 'category');
...
INSERT INTO `cart` (`id`, `status`, `created_at`, `modified_at`, `creator_id`, `modifier_id`, `user_id`, `product_id`, `qty`) VALUES
('012530da-8823-11ed-86c0-c465162ee099', 1, '2022-12-30 03:19:04', NULL, NULL, NULL, '004ec56b-87de-11ed-86c0-c465162ee099', '7936525b-83ab-11ed-8270-b0227a7395f6', 1);
...
INSERT INTO `configuration` (`id`, `status`, `created_at`, `modified_at`, `creator_id`, `modifier_id`, `title`, `keyword`, `author`, `text1_status`, `text1_text`, `text2_status`, `text2_text`, `header_top_status`, `frontend_logo_name`, `extranet_logo_name`, `phone`, `header_middle_status`, `address`, `email`, `working_day`, `description`, `copyright`) VALUES
('76c26f41-8397-11ed-8270-b0227a7395f6', 1, '2022-12-24 15:26:24', NULL, NULL, NULL, 'Dias Project', 'Dias Project, Ecommerce Website', NULL, 0, 'Get Up to 40% OFF New-Season Styles MEN WOMEN * Limited time only.', 1, 'FREE RETURNS. STANDARD SHIPPING ORDERS $99+', 0, '1672235346_71bbf69cc574224f678f.png', '1672235346_c4aecbdb867c4fdc7ff4.png', '+123 5678 890', 0, '123 Street Name, City, England', 'mail@example.com', 'Mon - Sun / 9:00 AM - 8:00 PM', 'Dias Project, Ecommerce Website', '© Dias Project. 2022. All Rights Reserved');
...
('0d4b1537-8439-11ed-bfb0-b0227a7395f6', 1, '2022-12-25 10:45:23', NULL, NULL, NULL, 'Fashion Deals', 'banner-5.jpg', 'Top Fashion', 'Deals', 'View Sale', 'category', 'Exclusive COUPON', 'UP TO', '$100', 'OFF');
...
INSERT INTO `product` (`id`, `status`, `created_at`, `modified_at`, `creator_id`, `modifier_id`, `category_id`, `sku`, `name`, `rating`, `short_description`, `description`, `price`, `qty`, `discount`, `tag`, `image1`, `image2`, `image3`, `is_featured`, `is_new_arrival`) VALUES
...
('92fb57f1-83ab-11ed-8270-b0227a7395f6', 1, '2022-12-24 17:53:23', NULL, NULL, NULL, 'watches', 'Watches', 'category-4.jpg'),
...
INSERT INTO `slider` (`id`, `status`, `created_at`, `modified_at`, `creator_id`, `modifier_id`, `image`, `text1`, `text2`, `text3`, `text4`, `text5`, `text_button`, `button_link`) VALUES
('6894bdc0-8407-11ed-bfb0-b0227a7395f6', 1, '2022-12-25 04:48:13', NULL, NULL, NULL, 'slide-1.jpg', 'Find the Boundaries. Push Through!', 'Summer Sale', '70% Off', 'Starting At', 'Rp. 250.000', 'Shop Now!', 'category'),
('689516fb-8407-11ed-bfb0-b0227a7395f6', 1, '2022-12-25 04:48:13', NULL, NULL, NULL, 'slide-2.jpg', 'Extra', '20% off', 'Accessories', 'Summer Sale', NULL, 'Shop All Sale', 'category');
...
INSERT INTO `user` (`id`, `status`, `created_at`, `modified_at`, `creator_id`, `modifier_id`, `name`, `email`, `password`, `role_code`) VALUES
('004ec56b-87de-11ed-86c0-c465162ee099', 0, '2022-12-29 19:05:07', NULL, NULL, NULL, NULL, 'dodinovembri32@gmail.com', '$2y$10$X3FkzNW2bngKPRJVyjyKZOxZ5yb095jEAp5vVRTeBp4Lxn9wb5.Ya', 1),
('51cd4cd0-852c-11ed-8355-b0227a7395f6', 1, '2022-12-26 15:47:17', NULL, NULL, NULL, 'Dias Project', 'diasproject@gmail.com', '$2y$10$Dy439KYYQ1qI8VmbSjoEwe3cpzBt5tjmtq5Dv9OzdzkZztjI8DfHK', 0);
