...
INSERT INTO `configuration` (`id`, `status`, `created_at`, `modified_at`, `creator_id`, `modifier_id`, `title`, `keyword`, `author`, `text1_status`, `text1_text`, `text2_status`, `text2_text`, `frontend_logo_name`, `extranet_logo_name`, `phone`, `address`, `email`, `working_day`, `description`, `copyright`) VALUES
('76c26f41-8397-11ed-8270-b0227a7395f6', 1, '2022-12-24 15:26:24', NULL, NULL, NULL, 'Dias Project', 'Dias Project, Ecommerce Website', NULL, 1, 'Get Up to 40% OFF New-Season Styles MEN WOMEN * Limited time only.', 1, 'FREE RETURNS. STANDARD SHIPPING ORDERS $99+', '1672235346_71bbf69cc574224f678f.png', '1672235346_c4aecbdb867c4fdc7ff4.png', '+123 5678 890', '123 Street Name, City, England', 'mail@example.com', 'Mon - Sun / 9:00 AM - 8:00 PM', 'Dias Project, Ecommerce Website', '© Dias Project. 2022. All Rights Reserved');
...
INSERT INTO `user` (`id`, `status`, `created_at`, `modified_at`, `creator_id`, `modifier_id`, `name`, `email`, `password`) VALUES
('51cd4cd0-852c-11ed-8355-b0227a7395f6', 1, '2022-12-26 15:47:17', NULL, NULL, NULL, 'Dias Project', 'diasproject@gmail.com', '$2y$10$Dy439KYYQ1qI8VmbSjoEwe3cpzBt5tjmtq5Dv9OzdzkZztjI8DfHK');
