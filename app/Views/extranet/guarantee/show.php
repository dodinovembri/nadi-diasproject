                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        <label>Icon</label>
                                        <input class="form-control" value="<?= $guarantee->icon ?>"  disabled/>
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label>Name</label>
                                        <input class="form-control" value="<?= $guarantee->name ?>" disabled/>
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label>Description</label>
                                        <textarea class="form-control" disabled><?= $guarantee->description ?></textarea>
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label>Status</label>
                                        <input class="form-control" type="text" value="<?= $guarantee->status == 1 ? 'Active' : 'Inactive' ?>" disabled />
                                    </div>
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        <a href="<?= base_url('extranet/guarantee') ?>"><button class="btn btn-primary">Back to List</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
