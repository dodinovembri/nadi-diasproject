...
<head>
    ...
    <title>Guarantees | Dias Project</title>
    ...
    <div class="app-admin-wrap layout-sidebar-large">
        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                ...
                <a href="<?= base_url('extranet/guarantee/create') ?>"><button class="btn btn-primary ripple" type="button">Create New</button><br><br></a>
                <div class="row mb-4">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($guarantees as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="text-success mr-2" href="<?= base_url('extranet/guarantee/show/' . $value->id) ?>">
                                                            <i class="nav-icon i-Eye font-weight-bold"></i>
                                                        </a>
                                                        <a class="text-success mr-2" href="<?= base_url('extranet/guarantee/edit/' . $value->id) ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="<?= base_url('extranet/guarantee/destroy/' . $value->id) ?>"><button class="btn btn-primary ml-2" type="button">Delete</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
