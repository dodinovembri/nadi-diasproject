                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        <label>Role</label>
                                        <input class="form-control" type="text" value="<?= $user->role_code == 0 ? "Administrator" : "User" ?>" disabled />
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label>Image</label>
                                        <img src="<?= base_url('assets/images/users/' . $user->image) ?>" height="120" alt="User Image">
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label>Status</label>
