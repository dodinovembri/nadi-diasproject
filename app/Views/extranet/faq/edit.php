                                ...
                                <form action="<?= base_url('extranet/faq/update/' . $faq->id) ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="question" value="<?= $faq->question ?>" placeholder="Enter question" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Description</label>
                                            <textarea rows="7" class="form-control" placeholder="Enter answer" name="answer" ><?= $faq->answer ?></textarea>
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
