                                ...
                                <form action="<?= base_url('extranet/slider/store') ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input class="form-control" type="text" name="name" placeholder="Enter slider name" required />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Image</label>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Text 3</label>
                                            <input class="form-control" type="text" name="text3" placeholder="Enter text 3" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Text 4</label>
                                            <input class="form-control" type="text" name="text4" placeholder="Enter text 4" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Text 5</label>
                                            <input class="form-control" type="text" name="text5" placeholder="Enter text 5" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
