            ...
            <div class="main-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="<?= base_url('extranet/support/store') ?>" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Icon Name</label>
                                            <input class="form-control" type="text" name="icon" placeholder="Enter icon name" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Name</label>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Text 3</label>
                                            <input class="form-control" type="text" name="text3" placeholder="Enter text button" />
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Status</label>
