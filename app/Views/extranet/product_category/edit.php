        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            <div class="main-content">
                <div class="breadcrumb">
                    ...
                    <ul>
                        <li><a href="<?= base_url('extranet/product-category') ?>">Product Category</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="<?= base_url('extranet/product-category/update/' . $product_category->id) ?>" method="post">
                                    <div class="row">
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Code</label>
                                            <input class="form-control" type="text" name="code" value="<?= $product_category->code ?>" placeholder="Enter code" required/>
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Name</label>
                                            <input class="form-control" type="text" name="name" value="<?= $product_category->name ?>" placeholder="Enter name" required/>
                                        </div>
                                        <div class="col-md-6 form-group mb-3">
                                            <label>Image</label>
                                            <img src="<?= base_url('assets/images/product_categories/' . $product_category->image) ?>" height="120" alt="">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <select class="form-control" name="status">
                                                <?php if ($product_category->status == 0) { ?>
                                                    <option value="0">Inactive</option>
                                                    <option value="1">Active</option>
                                                <?php } elseif ($product_category->status == 1) { ?>
                                                    <option value="1">Active</option>
                                                    <option value="0">Inactive</option>
                                                <?php } ?>
                                            </select>
                                        ...
                                        <div class="col-md-12" style="margin-top: 20px;">
                                            ...
                                            <a href="<?= base_url('extranet/product-category') ?>"><button type="button" class="btn btn-warning">Cancel</button></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
