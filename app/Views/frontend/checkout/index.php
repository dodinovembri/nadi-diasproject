                            ...
                            <div class="col-lg-6 mx-auto">
                                <div class="col-md-12">
                                    <div class="order-summary">
                                        ...
                                        <table class="table table-mini-cart">
                                                    ...
                                                    <tr>
                                                        <td class="product-col">
                                                            <h3 class="product-title">
                                                                ...
                                                                <span class="product-qty"><?= $value->cart_qty ?></span>
                                                            </h3>
                                                        </td>
                                                        ...
                                                        <td class="price-col">
                                                            <span><?php
                                                                    ...
                                                                    echo "Rp. " . number_format($total_per_product, 0, ",", "."); ?></span>
                                                        </td>
                                                    </tr>
                                                <?php
                                            ...
                                            <tfoot>
                                                <tr class="cart-subtotal">
                                                    ...
                                                    <td class="price-col">
                                                        <span><?= "Rp. " . number_format($total_product, 0, ",", "."); ?></span>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="order-total">
                                                    ...
                                                    <td>
                                                        <b class="total-price"><span><?= "Rp. " . number_format($total_product, 0, ",", "."); ?></span></b>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                        ...
                                        <a href="<?= base_url('checkout/store') ?>"><button type="button" class="btn btn-dark btn-place-order" form="checkout-form">Confirm order</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
